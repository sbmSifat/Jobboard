<?php
    ...
    //echo functionName("sin");

    include 'comparefunc.php';
    //echo "<br>";
    ...
    if (isset($_POST['details']))
    {
        ...
        $_SESSION["jobEmail"] = $_POST['jobEmail'];
...
//    //$text1="this is Ar";
//    $text1=$TotalDescription;
//    $text2="graphic designer gulshan";
            ...
            <div class="row">
                <div class="col-md-7">
                    ...
                    <div class="custom-breadcrumbs">
                        ...
                        <h3 class="text-white font-weight-bold"> <?php echo $jobtype ." in ". $jobloc ?></h3>
                        <h3 class="text-white font-weight-bold"> <?php echo "Expected Salary-".$jobsal ?></h3>
                        <h3 class="text-white font-weight-bold"> <?php echo "Overtime Preference- ". $jobovert ?></h3>
                        <h3 class="text-white font-weight-bold"> <?php echo "Skills- ". $jobskills ?></h3>
                    </div>
                </div>
            </div>
        </div>
                ...
                for($x = 0; $x < count($alljobs); $x++){ ?>
                    ...
                    <div class="col-6 col-md-6 col-lg-4 mb-4 mb-lg-5"  >
                        ...
                        <div  id="jobAdvert" class="block__16443 text-center d-block" onmouseenter="showDetails(this)" onmouseleave="hideDetails(this)">
                            ...
                            <a href="mailto:<?php echo $alljobs[$x]->jobemail ?>?subject=Application on the job offered for the position <?php echo $alljobs[$x]->jobtype ?> at <?php echo $alljobs[$x]->jobcom ?>" target="_blank">
                            ...
                            <form method="post">
                                ...
                                <input type="hidden" name="jobEmail" value="<?php echo $alljobs[$x]->jobemail ?>">
